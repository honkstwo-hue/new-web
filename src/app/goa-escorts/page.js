...
export default function Goaescort(){
	return(
		<>
			<section>
				<div className="main">
					<div className="sliderbg">
						<div className="figure">
							<Image src="/images/goa-header.webp" width="1920" height="804" alt="" />
					...
					<div className="container">
						<div className="row">
							<div className="col-lg-6 col-md-12">
								<div className="figure"><Image src="/images/about-goa.webp" width="726" height="472" alt=""/></div>
							</div>
							<div className="col-lg-6 col-md-12">
								<div className="subtitle">Sexy Escorts</div>
								<h2 className="title">Enjoy Life with The Sexiest  Escort in Goa</h2>
						...
						<div className="row">
							<div className="col-lg-3 col-md-6 col-12">
								...
								<div className="figure">
									...
									<div className="overlay">
										<div className="title">Dharti</div>
									</div>
								</div>
								</Link>
							</div>
							...
							<div className="col-lg-3 col-md-6 col-12">
								...
								<div className="figure">
									...
									<div className="overlay">
										<div className="title">Rewati</div>
									</div>
								</div>
								</Link>
							</div>
							<div className="col-lg-3 col-md-6 col-12">
								<Link href="/goa-escorts/soumya/">
								<div className="figure">
									<Image src="/images/soumya/so1.webp" width="385" height="525" alt=""/>
									<div className="overlay">
										<div className="title">Soumya</div>
									</div>
								</div>
								</Link>
							</div>
							<div className="col-lg-3 col-md-6 col-12">
								<Link href="/goa-escorts/simran/">
								<div className="figure">
									<Image src="/images/simran/sm1.webp" width="385" height="525" alt=""/>
									<div className="overlay">
										<div className="title">Simran</div>
									</div>
								</div>
								</Link>
							</div>
							<div className="col-lg-3 col-md-6 col-12">
								...
								<div className="figure">
									...
									<div className="overlay">
										<div className="title">Trisha</div>
									</div>
								</div>
								</Link>
							</div>
			...
			<section>
				<div className="seosection">
					<div className="container text-center">
						<h2 className="maintitle">Meet the Sizzling  Escort for Hookup in Goa</h2>
						<div className="shrtdesc">
