...
export default function Simranescort(){
	return(
		<>
			<section>
				<div className="main">
					<div className="sliderbg">
						<div className="figure">
							<Image src="/images/simran-header.webp" width="1920" height="804" alt="" />
					...
					<div className="container">
						<div className="row">
							<div className="col-md-12 text-center">
								<div className="subtitle">Simran Goa Escort</div>
								<h2 className="title">Enjoy Happy Time With Simran</h2>
			...
			<section>
				<div className="profilebg">
					<div className="container">
						<h2 className="maintitle text-center">Simran -	 Goa High Profile Call Girl</h2>
								...
								<div className="figurebg">
									<div className="row">
										<div className="col-lg-6 col-md-6 col-12">
											<div className="figure"><Image src="/images/simran/sm1.webp" width="385" height="525" alt=""/></div>
										</div>
										<div className="col-lg-6 col-md-6 col-12">
											<div className="figure"><Image src="/images/simran/sm2.webp" width="385" height="525" alt=""/></div>
										</div>
									</div>
									<div className="booknow text-center"><Link href="">- Book Simran Quick -</Link></div>
								</div>
							</div>
						...
						<div className="figurebg">
							<div className="row">
								<div className="col-lg-3 col-md-6 col-12">
									<Link href="/goa-escorts/trisha/">
									<div className="figure">
										<Image src="/images/trisha/tr1.webp" width="385" height="525" alt=""/>
										<div className="overlayprofile">
											<div className="caption">
												<div className="title">Trisha Goa Escort</div>
								...
								<div className="col-lg-3 col-md-6 col-12">
									<Link href="/goa-escorts/dharti/">
									<div className="figure">
										<Image src="/images/dharti/dr1.webp" width="385" height="525" alt=""/>
										<div className="overlayprofile">
											<div className="caption">
												<div className="title">Dharti Goa Escort</div>
												<div className="readmore">- Read More -</div>
											</div>
										</div>
									</div>
								...
								<div className="col-lg-3 col-md-6 col-12">
									<Link href="/goa-escorts/kavya/">
									<div className="figure">
										<Image src="/images/kavya/kv1.webp" width="385" height="525" alt=""/>
										<div className="overlayprofile">
											<div className="caption">
												<div className="title">Kavya Goa Escort</div>
												<div className="readmore">- Read More -</div>
											</div>
										</div>
									</div>
								...
								<div className="col-lg-3 col-md-6 col-12">
									<Link href="/goa-escorts/laren/">
									<div className="figure">
										<Image src="/images/laren/lr1.webp" width="385" height="525" alt=""/>
										<div className="overlayprofile">
											<div className="caption">
												<div className="title">Laren Goa Escort</div>
												<div className="readmore">- Read More -</div>
											</div>
										</div>
									</div>
			...
			<section>
				<div className="seosection">
					<div className="container text-center">
						<h2 className="maintitle">Meet the Sizzling Simran for Hookup <br/>in Goa</h2>
						<div className="shrtdesc">
