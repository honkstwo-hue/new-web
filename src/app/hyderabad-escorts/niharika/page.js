...
export default function Niharikaescort(){
	return(
		<>
			<section>
				<div className="main">
					<div className="sliderbg">
						<div className="figure">
							<Image src="/images/niharika-header.webp" width="1920" height="804" alt="" />
					...
					<div className="container">
						<div className="row">
							<div className="col-md-12 text-center">
								<div className="subtitle">Niharika Hyderabad Escort</div>
								<h2 className="title">Enjoy Happy Time With Niharika</h2>
			...
			<section>
				<div className="profilebg">
					<div className="container">
						<h2 className="maintitle text-center">Niharika -	 Hyderabad High Profile Call Girl</h2>
								...
								<div className="figurebg">
									<div className="row">
										<div className="col-lg-6 col-md-6 col-12">
											<div className="figure"><Image src="/images/niharika/nr1.webp" width="385" height="525" alt=""/></div>
										</div>
										<div className="col-lg-6 col-md-6 col-12">
											<div className="figure"><Image src="/images/niharika/nr2.webp" width="385" height="525" alt=""/></div>
										</div>
									</div>
									<div className="booknow text-center"><Link href="">- Book Deepika Quick -</Link></div>
								</div>
							</div>
					...
					<div className="container-fluid">
						...
						<div className="row  justify-content-center">
							<div className="col-lg-5 col-md-12">
								<h2 className="maintitle text-center">Related Escorts</h2>
								<div className="borwhitebg"></div>
							</div>
						</div>
						<div className="figurebg">
							<div className="row">
								<div className="col-lg-3 col-md-6 col-12">
									...
									<div className="figure">
										...
										<div className="overlayprofile">
											<div className="caption">
												<div className="title">Jaspreet Hyderabad Escort</div>
								...
								<div className="col-lg-3 col-md-6 col-12">
									...
									<div className="figure">
										...
										<div className="overlayprofile">
											<div className="caption">
												<div className="title">Devika Hyderabad Escort</div>
												<div className="readmore">- Read More -</div>
											</div>
										</div>
									</div>
								...
								<div className="col-lg-3 col-md-6 col-12">
									...
									<div className="figure">
										...
										<div className="overlayprofile">
											<div className="caption">
												<div className="title">Poonam Hyderabad Escort</div>
												<div className="readmore">- Read More -</div>
											</div>
										</div>
									</div>
								...
								<div className="col-lg-3 col-md-6 col-12">
									...
									<div className="figure">
										...
										<div className="overlayprofile">
											<div className="caption">
												<div className="title">Awantika Hyderabad Escort</div>
												<div className="readmore">- Read More -</div>
											</div>
										</div>
									</div>
			...
			<section>
				<div className="seosection">
					<div className="container text-center">
						<h2 className="maintitle">Meet the Sizzling Niharika for Hookup <br/>in Hyderabad</h2>
						<div className="shrtdesc">
