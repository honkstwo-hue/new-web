		...
		<>
				...
				<div className="main">
					<div className="sliderbg">
						<div className="figure">
							<Image src="/images/ana-header.webp" width="1920" height="804" alt="" />
					...
					<div className="container">
						<div className="row">
							<div className="col-md-12 text-center">
								<div className="subtitle">Ana Hyderabad Escort</div>
								<h2 className="title">Enjoy Happy Time With Ana</h2>
			...
			<section>
				<div className="profilebg">
					<div className="container">
						<h2 className="maintitle text-center">Ana -	 Hyderabad High Profile Call Girl</h2>
								...
								<div className="figurebg">
									<div className="row">
										<div className="col-lg-6 col-md-6 col-12">
											<div className="figure"><Image src="/images/ana/ana1.webp" width="385" height="525" alt=""/></div>
										</div>
										<div className="col-lg-6 col-md-6 col-12">
											<div className="figure"><Image src="/images/ana/ana3.webp" width="385" height="525" alt=""/></div>
										</div>
									</div>
								...
								<div className="col-lg-3 col-md-6 col-12">
									...
									<div className="figure">
										...
										<div className="overlayprofile">
											<div className="caption">
												<div className="title">Awntika Hyderabad Escort</div>
			...
			<section>
				<div className="seosection">
					<div className="container text-center">
						<h2 className="maintitle">Meet the Sizzling Ana for Hookup <br/>in Hyderabad</h2>
						<div className="shrtdesc">
