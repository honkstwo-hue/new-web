...
export default function Sanyaescort(){
	return(
		<>
			<section>
				<div className="main">
					<div className="sliderbg">
						<div className="figure">
							<Image src="/images/sanya-header.webp" width="1920" height="804" alt="" />
					...
					<div className="container">
						<div className="row">
							<div className="col-md-12 text-center">
								<div className="subtitle">Sanya Kolkata Escort</div>
								<h2 className="title">Enjoy Happy Time With Sanya</h2>
			...
			<section>
				<div className="profilebg">
					<div className="container">
						<h2 className="maintitle text-center">Sanya -	 Kolkata High Profile Call Girl</h2>
								...
								<div className="figurebg">
									<div className="row">
										<div className="col-lg-6 col-md-6 col-12">
											<div className="figure"><Image src="/images/sanya/sn1.webp" width="385" height="525" alt=""/></div>
										</div>
										<div className="col-lg-6 col-md-6 col-12">
											<div className="figure"><Image src="/images/sanya/sn2.webp" width="385" height="525" alt=""/></div>
										</div>
									</div>
									<div className="booknow text-center"><Link href="">- Book Sanya Quick -</Link></div>
								</div>
							</div>
					...
					<div className="container-fluid">
						...
						<div className="figurebg">
							<div className="row">
								...
								<div className="col-lg-3 col-md-6 col-12">
									<Link href="/kolkata-escorts/alisha/">
									<div className="figure">
										<Image src="/images/alisha/al1.webp" width="385" height="525" alt=""/>
										<div className="overlayprofile">
											<div className="caption">
												<div className="title">Alisha Kolkata Escort</div>
												<div className="readmore">- Read More -</div>
											</div>
										</div>
									</div>
			...
			<section>
				<div className="seosection">
					<div className="container text-center">
						<h2 className="maintitle">Meet the Sizzling Sanya for Hookup <br/>in Kolkata</h2>
						<div className="shrtdesc">
