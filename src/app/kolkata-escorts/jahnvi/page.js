...
export default function Jahnviescort(){
	return(
		<>
			<section>
				<div className="main">
					<div className="sliderbg">
						<div className="figure">
							<Image src="/images/jahnvi-header.webp" width="1920" height="804" alt="" />
					...
					<div className="container">
						<div className="row">
							<div className="col-md-12 text-center">
								<div className="subtitle">Jahnvi Kolkata Escort</div>
								<h2 className="title">Enjoy Happy Time With Jahnvi</h2>
			...
			<section>
				<div className="profilebg">
					<div className="container">
						<h2 className="maintitle text-center">Jahnvi -	 Kolkata High Profile Call Girl</h2>
								...
								<div className="figurebg">
									<div className="row">
										<div className="col-lg-6 col-md-6 col-12">
											<div className="figure"><Image src="/images/jahnvi/jn1.webp" width="385" height="525" alt=""/></div>
										</div>
										<div className="col-lg-6 col-md-6 col-12">
											<div className="figure"><Image src="/images/jahnvi/jn2.webp" width="385" height="525" alt=""/></div>
										</div>
									</div>
									<div className="booknow text-center"><Link href="">- Book Jahnvi Quick -</Link></div>
								</div>
							</div>
							...
							<div className="row">
								...
								<div className="col-lg-3 col-md-6 col-12">
									...
									<div className="figure">
										...
										<div className="overlayprofile">
											<div className="caption">
												<div className="title">Ruhi Kolkata Escort</div>
												<div className="readmore">- Read More -</div>
											</div>
										</div>
									</div>
			...
			<section>
				<div className="seosection">
					<div className="container text-center">
						<h2 className="maintitle">Meet the Sizzling Jahnvi for Hookup <br/>in Kolkata</h2>
						<div className="shrtdesc">
