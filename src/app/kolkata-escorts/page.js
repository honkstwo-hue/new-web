...
export default function Kolkataescort(){
	return(
		<>
			<section>
				<div className="main">
					<div className="sliderbg">
						<div className="figure">
							<Image src="/images/kolkata-header.webp" width="1920" height="804" alt="" />
							<div className="absolutepath">
								<div className="container">
									<div className="caption">
										<h1>Kolkata Escorts</h1>
					...
					<div className="container">
						<div className="row">
							<div className="col-lg-6 col-md-12">
								<div className="figure"><Image src="/images/about-kolkata.webp" width="726" height="472" alt=""/></div>
							</div>
							<div className="col-lg-6 col-md-12">
								<div className="subtitle">Sexy Escorts</div>
								<h2 className="title">Enjoy Life with The Sexiest  Escort in Kolkata</h2>
						...
						<div className="row">
							<div className="col-lg-3 col-md-6 col-12">
								...
								<div className="figure">
									...
									<div className="overlay">
										<div className="title">Alisha</div>
									</div>
								</div>
								</Link>
							</div>
							<div className="col-lg-3 col-md-6 col-12">
								...
								<div className="figure">
									...
									<div className="overlay">
										<div className="title">Deepika</div>
									</div>
								</div>
								</Link>
							</div>
							<div className="col-lg-3 col-md-6 col-12">
								...
								<div className="figure">
									...
									<div className="overlay">
										<div className="title">Jahnvi</div>
									</div>
								</div>
								</Link>
							</div>
							<div className="col-lg-3 col-md-6 col-12">
								...
								<div className="figure">
									...
									<div className="overlay">
										<div className="title">Madhuri</div>
									</div>
								</div>
								</Link>
							</div>
							<div className="col-lg-3 col-md-6 col-12">
								<Link href="/kolkata-escorts/mancy/">
								<div className="figure">
									<Image src="/images/nancy/nanc1.webp" width="385" height="525" alt=""/>
									<div className="overlay">
										<div className="title">Nancy</div>
									</div>
								</div>
								</Link>
							</div>
							<div className="col-lg-3 col-md-6 col-12">
								<Link href="/kolkata-escorts/pamela/">
								<div className="figure">
									<Image src="/images/pamela/pm1.webp" width="385" height="525" alt=""/>
									<div className="overlay">
										<div className="title">Pamela</div>
									</div>
								</div>
								</Link>
							</div>
							<div className="col-lg-3 col-md-6 col-12">
								<Link href="/kolkata-escorts/ruhi/">
								<div className="figure">
									<Image src="/images/ruhi/rh1.webp" width="385" height="525" alt=""/>
									<div className="overlay">
