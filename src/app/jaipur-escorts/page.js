...
export default function Jaipurescort(){
	return(
		<>
			<section>
				<div className="main">
					<div className="sliderbg">
						<div className="figure">
							<Image src="/images/jaipur-header.webp" width="1920" height="804" alt="" />
							<div className="absolutepath">
								<div className="container">
									<div className="caption">
										<h1>Jaipur Escorts</h1>
					...
					<div className="container">
						<div className="row">
							...
							<div className="col-lg-6 col-md-12">
								...
								<h2 className="title">Enjoy Life with The Sexiest  Escort in Jaipur</h2>
						...
						<div className="row">
							...
							<div className="col-lg-3 col-md-6 col-12">
								...
								<div className="figure">
									...
									<div className="overlay">
										<div className="title">Rumika</div>
									</div>
								</div>
								</Link>
							</div>
							<div className="col-lg-3 col-md-6 col-12">
								...
								<div className="figure">
									...
									<div className="overlay">
										<div className="title">Natasha</div>
									</div>
								</div>
								</Link>
							</div>
							<div className="col-lg-3 col-md-6 col-12">
								...
								<div className="figure">
									...
									<div className="overlay">
										<div className="title">Angela</div>
									</div>
								</div>
								</Link>
							</div>
							<div className="col-lg-3 col-md-6 col-12">
								...
								<div className="figure">
									...
									<div className="overlay">
										<div className="title">Kalpana</div>
									</div>
								</div>
								</Link>
							</div>
							...
							<div className="col-lg-3 col-md-6 col-12">
								...
								<div className="figure">
									...
									<div className="overlay">
										<div className="title">Tamanna</div>
									</div>
								</div>
								</Link>
							</div>
			...
			<section>
				<div className="seosection">
					<div className="container text-center">
						<h2 className="maintitle">Meet the Sizzling  Escort for Hookup in Jaipur</h2>
						<div className="shrtdesc">
