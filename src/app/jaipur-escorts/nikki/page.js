...
export default function Nikkiescort(){
	return(
		<>
			<section>
				<div className="main">
					<div className="sliderbg">
						<div className="figure">
							<Image src="/images/nikki-header.webp" width="1920" height="804" alt="" />
					...
					<div className="container">
						<div className="row">
							<div className="col-md-12 text-center">
								<div className="subtitle">Nikki Jaipur Escort</div>
								<h2 className="title">Enjoy Happy Time With Nikki</h2>
			...
			<section>
				<div className="profilebg">
					<div className="container">
						<h2 className="maintitle text-center">Nikki -	 Jaipur High Profile Call Girl</h2>
								...
								<div className="figurebg">
									<div className="row">
										<div className="col-lg-6 col-md-6 col-12">
											<div className="figure"><Image src="/images/nikki/nk1.webp" width="385" height="525" alt=""/></div>
										</div>
										<div className="col-lg-6 col-md-6 col-12">
											<div className="figure"><Image src="/images/nikki/nk2.webp" width="385" height="525" alt=""/></div>
										</div>
									</div>
									<div className="booknow text-center"><Link href="">- Book Nikki Quick -</Link></div>
								</div>
							</div>
			...
			<section>
				<div className="seosection">
					<div className="container text-center">
						<h2 className="maintitle">Meet the Sizzling Nikki for Hookup <br/>in Jaipur</h2>
						<div className="shrtdesc">
