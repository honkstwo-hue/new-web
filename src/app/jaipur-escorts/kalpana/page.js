...
export default function Kalpanaescort(){
	return(
		<>
			<section>
				<div className="main">
					<div className="sliderbg">
						<div className="figure">
							<Image src="/images/kalpana-header.webp" width="1920" height="804" alt="" />
					...
					<div className="container">
						<div className="row">
							<div className="col-md-12 text-center">
								<div className="subtitle">Kalpana Jaipur Escort</div>
								<h2 className="title">Enjoy Happy Time With Kalpana</h2>
			...
			<section>
				<div className="profilebg">
					<div className="container">
						<h2 className="maintitle text-center">Kalpana -	 Jaipur High Profile Call Girl</h2>
								...
								<div className="figurebg">
									<div className="row">
										<div className="col-lg-6 col-md-6 col-12">
											<div className="figure"><Image src="/images/kalpana/kl1.webp" width="385" height="525" alt=""/></div>
										</div>
										<div className="col-lg-6 col-md-6 col-12">
											<div className="figure"><Image src="/images/kalpana/kl2.webp" width="385" height="525" alt=""/></div>
										</div>
									</div>
									<div className="booknow text-center"><Link href="">- Book Kalpana Quick -</Link></div>
								</div>
							</div>
			...
			<section>
				<div className="seosection">
					<div className="container text-center">
						<h2 className="maintitle">Meet the Sizzling Kalpana for Hookup <br/>in Jaipur</h2>
						<div className="shrtdesc">
